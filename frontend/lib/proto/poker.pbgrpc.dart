...
class PokerServiceClient extends $grpc.Client {
  static final _$evaluateHand = $grpc.ClientMethod<$0.HandRequest, $0.HandResponse>(
  ...
  static final _$compareHands = $grpc.ClientMethod<$0.CompareRequest, $0.CompareResponse>(
      '/poker.PokerService/CompareHands',
      ($0.CompareRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.CompareResponse.fromBuffer(value));
  static final _$calculateProbability = $grpc.ClientMethod<$0.SimRequest, $0.SimResponse>(
  ...
  $grpc.ResponseFuture<$0.HandResponse> evaluateHand($0.HandRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$evaluateHand, request, options: options);
  }

  $grpc.ResponseFuture<$0.CompareResponse> compareHands($0.CompareRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$compareHands, request, options: options);
  }

  $grpc.ResponseFuture<$0.SimResponse> calculateProbability($0.SimRequest request, {$grpc.CallOptions? options}) {
...
abstract class PokerServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.HandResponse> evaluateHand_Pre($grpc.ServiceCall call, $async.Future<$0.HandRequest> request) async {
    return evaluateHand(call, await request);
  }

  $async.Future<$0.CompareResponse> compareHands_Pre($grpc.ServiceCall call, $async.Future<$0.CompareRequest> request) async {
    return compareHands(call, await request);
  }

  $async.Future<$0.SimResponse> calculateProbability_Pre($grpc.ServiceCall call, $async.Future<$0.SimRequest> request) async {
    return calculateProbability(call, await request);
  }

  $async.Future<$0.HandResponse> evaluateHand($grpc.ServiceCall call, $0.HandRequest request);
  $async.Future<$0.CompareResponse> compareHands($grpc.ServiceCall call, $0.CompareRequest request);
  $async.Future<$0.SimResponse> calculateProbability($grpc.ServiceCall call, $0.SimRequest request);
}
